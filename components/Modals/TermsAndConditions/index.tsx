...
const TermsAndConditions: React.FC<TermsAndConditionsProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} onClick={onClose} size={size}>
      <ModalContent >
        <div className="fixed inset-0 flex items-center justify-center">
          <div className="bg-white w-full max-w-[80%] h-[90%] p-2 rounded-lg overflow-y-auto">
            <div className="flex justify-end">
              <button onClick={onClose}>
                <FiX className=" w-8 h-8 cursor-pointer" />
              </button>
            </div>
            <ModalBody className="text-[13px] ml-2 list-decimal leading-loose font-Avenir tracking-wide">
